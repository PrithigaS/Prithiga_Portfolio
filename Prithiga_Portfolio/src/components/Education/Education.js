  ...
  const educationData = [
    {
      ...
      duration: "2021 - 2025",
      description:
        "Focused on software development, algorithms, networks, databases, AI, and modern computing technologies.",
    },
    {
      institution: "A.V.MEIYAPPAN MATRICULATION HIGHER SECONDARYSCHOOL",
